      ...
      axios.post('/users/register', data)
        .then(res => {
          ...
          if(status !== true) {
            ...
            this.handleOpenDialog(message, 'Now you can login with your email and password on the home screen :D');
          }
        })
        ...
        <form onSubmit={this.handleRegister} className={classes.root}>
          ...
          >
            ...
            {(this.state.beforeSubmitError && this.state.name === '') &&
              <FormHelperText id="password-error-text">Please input Full Name</FormHelperText>
            }
          </FormControl>
          {/* EMAIL */}
          <FormControl
          ...
          >
            ...
            {(this.state.beforeSubmitError && this.state.birthDate === '') &&
              <FormHelperText id="birthdate-error-text">Please input a Birth Date</FormHelperText>
            }
          </FormControl>
          ...
          >
            ...
            {(this.state.beforeSubmitError && this.state.password === '') &&
              <FormHelperText id="password-error-text">Please input password</FormHelperText>
            }
          </FormControl>
